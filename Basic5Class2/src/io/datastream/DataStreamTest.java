...
//					FileOutputStream fos = new FileOutputStream("data.txt");//자바에서 파일로 출력하는 통로 : 스트림
//					DataOutputStream dos = new DataOutputStream(fos);//필터 역할
					DataOutputStream dos = new DataOutputStream(new FileOutputStream("data.txt"));//데이터 형으로 쓸 수 있게 필터링 필터 역할
